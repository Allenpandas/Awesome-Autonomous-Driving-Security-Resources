# Research-Tools-for-Computer-Science

**Research-Tools-for-Computer-Science** (RT4CS): Research tools commonly used in computer-related majors such as computer science and technology, cyberspace security, software engineering, signal and information processing, Artificial Intelligence, etc. | **Research-Tools-for-Computer-Science** （计算机科研工具包）： 计算机科学与技术、网络空间安全、软件工程、信号与信息处理、人工智能等计算机相关专业常用的科研工具。
